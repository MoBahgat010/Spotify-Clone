...
function AlbumCard(props) {
    return (
        <div className="hover:bg-[#1A1A1A] rounded-lg hover:cursor-pointer p-3 group">
            <Link to={`/dashboard/album/${props.albumID}`} className="non-artist-card">
                ...
                <div className="pt-3">
                    <Link to={`/dashboard/artist/${props.artistID}`} className="text-white pl-1 hover:underline line-clamp-1">{props.artistName}</Link>
